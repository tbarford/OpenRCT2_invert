    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (direction)
    {
        case 0:
            PaintAddImageAsParentRotated(
                ...
                { 0, 0, height - 5 + kInvertedSpriteOffset },
                { { 0, 6, height - 5 + kInvertedSpriteOffset + 16 }, { 32, 20, 3 } });
            break;
        case 1:
            PaintAddImageAsParentRotated(
                session, direction, session.TrackColours.WithIndex((SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP + 1)),
                { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 4, height - 5 + kInvertedSpriteOffset }, { 32, 2, 43 } });
            PaintAddImageAsParentRotated(
                session, direction, session.TrackColours.WithIndex((SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP + 2)),
                { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 29, 4, height - 5 + kInvertedSpriteOffset }, { 1, 24, 43 } });
            break;
        case 2:
            PaintAddImageAsParentRotated(
    ...
    {
        PaintUtilPushTunnelRotated(session, direction, height - 5 + 24, kTunnelGroup, TunnelSubType::SlopeEnd);
    }

    PaintUtilSetGeneralSupportHeight(session, height - 5 + 72);
}
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    switch (direction)
    {
        case 0:
            PaintAddImageAsParentRotated(
                ...
                { 0, 0, height - 5 + kInvertedSpriteOffset },
                { { 0, 6, height - 5 + kInvertedSpriteOffset + 24 }, { 32, 20, 3 } });
            MetalASupportsPaintSetup(
                session, supportType.metal, MetalSupportPlace::centre, 0, height - 5 + kSupportHeight + 20,
                session.SupportColours);
            break;
        case 1:
            PaintAddImageAsParentRotated(
                session, direction, session.TrackColours.WithIndex((SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP + 7)),
                { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 6, height - 5 }, { 32, 1, kInvertedSpriteOffset + 24 } });
            PaintAddImageAsParentRotated(
    ...
    if (direction == 0 || direction == 3)
    {
        PaintUtilPushTunnelRotated(session, direction, height - 5 - 8, kTunnelGroup, TunnelSubType::SlopeStart);
    }
    else
    {
        PaintUtilPushTunnelRotated(session, direction, height - 5 + 24, kTunnelGroup, TunnelSubType::Flat);
    }

    PaintUtilSetGeneralSupportHeight(session, height - 5 + 80);
}
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        case 0:
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 56);
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 6, height - 5 + kInvertedSpriteOffset }, { 32, 20, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
            ...
            if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            {
                switch (direction)
                {
                    case 0:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::topRightSide, 0, height - 5 + kSupportHeight + 4,
                            session.SupportColours);
                        break;
                    case 1:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::bottomRightSide, 0, height - 5 + kSupportHeight + 4,
                            session.SupportColours);
                        break;
                    case 2:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::bottomLeftSide, 0, height - 5 + kSupportHeight + 4,
                            session.SupportColours);
                        break;
                    case 3:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::topLeftSide, 0, height - 5 + kSupportHeight + 4,
                            session.SupportColours);
                        break;
                }
            }
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 6, height - 5 + 37 }, { 32, 20, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
            ...
            if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
                if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
                {
                    switch (direction)
                    {
                        case 0:
                            MetalASupportsPaintSetup(
                                session, supportType.metal, MetalSupportPlace::topRightSide, 0, height - 5 + 65,
                                session.SupportColours);
                            break;
                        case 1:
                            MetalASupportsPaintSetup(
                                session, supportType.metal, MetalSupportPlace::bottomRightSide, 0, height - 5 + 65,
                                session.SupportColours);
                            break;
                        case 2:
                            MetalASupportsPaintSetup(
                                session, supportType.metal, MetalSupportPlace::bottomLeftSide, 0, height - 5 + 65,
                                session.SupportColours);
                            break;
                        case 3:
                            MetalASupportsPaintSetup(
                                session, supportType.metal, MetalSupportPlace::topLeftSide, 0, height - 5 + 65,
                                session.SupportColours);
                            break;
                    }
                }
        ...
        case 2:
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 6, height - 5 + 49 }, { 32, 20, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
            ...
            if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            {
                switch (direction)
                {
                    case 0:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::topRightSide, 0, height - 5 + 72,
                            session.SupportColours);
                        break;
                    case 1:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::bottomRightSide, 0, height - 5 + 76,
                            session.SupportColours);
                        break;
                    case 2:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::bottomLeftSide, 0, height - 5 + 72,
                            session.SupportColours);
                        break;
                    case 3:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::topLeftSide, 0, height - 5 + 72,
                            session.SupportColours);
                        break;
                }
            }
        ...
        case 3:
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 6, height - 5 + 83 }, { 32, 20, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        session, direction, session.TrackColours.WithIndex(SPR_TRACKS_BM_INVERT_FLAT_TO_STEEP + 7),
                        { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 4, height - 5 + 11 }, { 32, 2, 75 } });
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
            ...
            {
                case 1:
                    PaintUtilPushTunnelRight(session, height - 5 + 24, kTunnelGroup, TunnelSubType::SlopeEnd);
                    break;
                case 2:
                    PaintUtilPushTunnelLeft(session, height - 5 + 24, kTunnelGroup, TunnelSubType::SlopeEnd);
                    break;
            }

            PaintUtilSetGeneralSupportHeight(session, height - 5 + 88);
            break;
    }
}
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        ...
        case 1:
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 6, height - 5 + 57 }, { 32, 20, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
            ...
            if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            {
                switch (direction)
                {
                    ...
                    case 1:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::bottomRightSide, 0, height - 5 + 74,
                            session.SupportColours);
                        break;
                    case 2:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::bottomLeftSide, 0, height - 5 + 76,
                            session.SupportColours);
                        break;
                    case 3:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::topLeftSide, 0, height - 5 + 74,
                            session.SupportColours);
                        break;
                }
            }
        ...
        case 2:
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 6, height - 5 + 45 }, { 32, 20, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
            ...
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 64);
            break;
        case 3:
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
            ...
            if (TrackPaintUtilShouldPaintSupports(session.MapPosition))
            {
                switch (direction)
                {
                    ...
                    case 1:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::bottomRightSide, 0, height - 5 + kSupportHeight + 8,
                            session.SupportColours);
                        break;
                    case 2:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::bottomLeftSide, 0, height - 5 + kSupportHeight + 10,
                            session.SupportColours);
                        break;
                    case 3:
                        MetalASupportsPaintSetup(
                            session, supportType.metal, MetalSupportPlace::topLeftSide, 0, height - 5 + kSupportHeight + 8,
                            session.SupportColours);
                        break;
                }
            }
            ...
            {
                case 1:
                    PaintUtilPushTunnelRight(session, height - 5 + 8, kTunnelGroup, TunnelSubType::FlatTo25Deg);
                    break;
                case 2:
                    PaintUtilPushTunnelLeft(session, height - 5 + 8, kTunnelGroup, TunnelSubType::FlatTo25Deg);
                    break;
            }

            PaintUtilSetGeneralSupportHeight(session, height - 5 + 48);
            break;
    }
}
            ...
            switch (direction)
            {
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 40 }, { 32, 32, 1 } });
                    break;
            }
    ...
    switch (trackSequence)
    {
            ...
            switch (direction)
            {
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 53 }, { 32, 32, 1 } });
                    break;
            }
        ...
        case 3:
            ...
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + kSupportHeight + 24,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 53 }, { 32, 32, 1 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 24,
                        session.SupportColours);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 24,
                        session.SupportColours);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 24,
                        session.SupportColours);
                    break;
            }
    ...
    switch (trackSequence)
    {
        ...
        case 3:
            ...
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + kSupportHeight + 20,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 53 }, { 32, 32, 1 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 20,
                        session.SupportColours);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 20,
                        session.SupportColours);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 20,
                        session.SupportColours);
                    break;
            }
    ...
    switch (trackSequence)
    {
        ...
        case 3:
            ...
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + kSupportHeight + 6,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 40 }, { 32, 32, 1 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 6,
                        session.SupportColours);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 6,
                        session.SupportColours);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 6,
                        session.SupportColours);
                    break;
            }
    ...
    switch (trackSequence)
    {
            ...
            switch (direction)
            {
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset },
                        { { -16, -16, height - 5 + kInvertedSpriteOffset + 8 }, { 32, 32, 3 } });
                    break;
            }

            PaintUtilSetGeneralSupportHeight(session, height - 5 + 40);
            break;
        case 1:
            PaintUtilSetSegmentSupportHeight(
                session,
        ...
        case 3:
            ...
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + kSupportHeight + 14,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { { -16, -16, height - 5 + kInvertedSpriteOffset + 8 }, { 32, 32, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 14,
                        session.SupportColours);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 9,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset },
                        { { -16, -16, height - 5 + kInvertedSpriteOffset + 24 }, { 32, 32, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 22,
                        session.SupportColours);
                    break;
            }
            ...
            switch (direction)
            {
                ...
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { { -16, -16, height - 5 + kInvertedSpriteOffset + 24 }, { 32, 32, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 40,
                        session.SupportColours);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                ...
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset },
                        { { -16, -16, height - 5 + kInvertedSpriteOffset + 64 }, { 32, 32, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 44,
                        session.SupportColours);
                    break;
            }

            PaintUtilSetGeneralSupportHeight(session, height - 5 + 104);
            break;
        case 7:
            PaintUtilSetSegmentSupportHeight(
                session,
            ...
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 128);
            break;
        case 8:
            PaintUtilSetSegmentSupportHeight(
                session,
        ...
        case 9:
            ...
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 144);
            break;
    }
}
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        ...
        case 1:
            ...
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 112);
            break;
        case 2:
            PaintUtilSetSegmentSupportHeight(
                session,
            ...
            switch (direction)
            {
                ...
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset },
                        { { -16, -16, height - 5 + kInvertedSpriteOffset + 72 }, { 32, 32, 3 } });

                    break;
            }

            PaintUtilSetGeneralSupportHeight(session, height - 5 + 120);
            break;
        case 4:
            PaintUtilSetSegmentSupportHeight(
                session,
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset },
                        { { -16, -16, height - 5 + kInvertedSpriteOffset + 32 }, { 32, 32, 3 } });
                    break;
            }
        ...
        case 6:
            ...
            switch (direction)
            {
                ...
                case 2:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 22,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
        ...
        case 9:
            ...
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + kSupportHeight + 12,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { { -16, -16, height - 5 + kInvertedSpriteOffset + 8 }, { 32, 32, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 16,
                        session.SupportColours);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 12,
                        session.SupportColours);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 16,
                        session.SupportColours);
                    break;
            }
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 6, height - 5 + kInvertedSpriteOffset }, { 32, 20, 3 });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::centre, 0, height - 5 + kSupportHeight + 6,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 6, height - 5 + kInvertedSpriteOffset }, { 32, 20, 3 });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::centre, 0, height - 5 + kSupportHeight + 8,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 6, 0, height - 5 + kInvertedSpriteOffset }, { 20, 32, 3 });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topLeftSide, 0, height - 5 + kSupportHeight + 8,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { 6, 0, height - 5 + kInvertedSpriteOffset }, { 20, 32, 3 });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topRightSide, 0, height - 5 + kSupportHeight + 9,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { 6, 0, height - 5 + kInvertedSpriteOffset }, { 20, 32, 3 });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomRightSide, 0, height - 5 + kSupportHeight + 9,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { 6, 0, height - 5 + kInvertedSpriteOffset }, { 20, 32, 3 });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomLeftSide, 0, height - 5 + kSupportHeight + 8,
                        session.SupportColours);
                    break;
            }
            ...
            switch (direction)
            {
                ...
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { 6, 0, height - 5 + kInvertedSpriteOffset }, { 20, 32, 3 });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomLeftSide, 0, height - 5 + kSupportHeight + 9,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                ...
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { 6, 0, height - 5 + kInvertedSpriteOffset }, { 20, 32, 3 });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topRightSide, 0, height - 5 + kSupportHeight + 8,
                        session.SupportColours);
                    break;
            }
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        case 0:
                ...
                switch (direction)
                {
                    case 0:
                        PaintAddImageAsParentRotated(
                            ...
                            { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 6, height - 5 + 85 }, { 32, 20, 3 } });
                        break;
                    case 1:
                        PaintAddImageAsParentRotated(
                            session, direction, session.TrackColours.WithIndex(SPR_TRACKS_BM_INVERT_VERTICAL + 1),
                            { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 4, height - 5 + 11 }, { 32, 2, 55 } });
                        break;
                    case 2:
                        PaintAddImageAsParentRotated(
            ...
            PaintUtilSetVerticalTunnel(session, height - 5 + 56);
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 72);
            break;
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    ...
    {
        case 1:
            PaintUtilPushTunnelRight(session, height - 5 + 48, kTunnelGroup, TunnelSubType::SlopeEnd);
            break;
        case 2:
            PaintUtilPushTunnelLeft(session, height - 5 + 48, kTunnelGroup, TunnelSubType::SlopeEnd);
            break;
    }
    PaintUtilSetSegmentSupportHeight(session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
    PaintUtilSetGeneralSupportHeight(session, height - 5 + 96);
}
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
        case 0:
            ...
            if (direction == 0 || direction == 3)
            {
                PaintUtilPushTunnelRotated(session, direction, height - 5 + 48, kTunnelGroup, TunnelSubType::SlopeEnd);
            }
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 96);
    ...
    const TrackElement& trackElement, const SupportType supportType)
{
    switch (trackSequence)
    {
        case 0:
            switch (direction)
            {
                ...
                case 2:
                    ...
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + 29 }, { { 0, 4, height - 5 + 11 }, { 32, 2, 31 } });
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
            ...
            PaintUtilSetVerticalTunnel(session, height - 5 + 96);
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 96);
            break;
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 28, 6, height - 5 + kInvertedSpriteOffset }, { 2, 20, 31 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        session, direction, session.TrackColours.WithIndex((SPR_TRACKS_BM_INVERT_QUARTER_LOOP + 4)),
                        { 0, 0, height - 5 + kInvertedSpriteOffset }, { { 0, 6, height - 5 + 16 }, { 20, 1, 48 } });
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 6, height - 5 + kInvertedSpriteOffset }, { 32, 20, 1 } });
                    PaintAddImageAsParentRotated(
                        session, direction, session.TrackColours.WithIndex((SPR_TRACKS_BM_INVERT_QUARTER_LOOP + 2)),
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 25, height - 5 + kInvertedSpriteOffset + 1 }, { 32, 1, 32 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
        ...
        case 2:
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 6, height - 5 + kInvertedSpriteOffset + 4 }, { 32, 20, 1 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
            ...
            if (direction == 0 || direction == 3)
            {
                PaintUtilPushTunnelRotated(session, direction, height - 5 + 32, kTunnelGroup, TunnelSubType::Flat);
            }
            PaintUtilSetSegmentSupportHeight(
                session, PaintUtilRotateSegments(BlockedSegments::kStraightFlat, direction), 0xFFFF, 0);
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 68);
            break;
    }
}
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 6, height - 5 + kInvertedSpriteOffset + 8 }, { 32, 20, 3 } });

                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::centre, 0, height - 5 + kSupportHeight + 10,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 0, height - 5 + kInvertedSpriteOffset }, { 32, 16, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                ...
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 16, height - 5 + kInvertedSpriteOffset }, { 32, 16, 3 } });
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 16, height - 5 + kInvertedSpriteOffset }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 13,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 16, 16, height - 5 + kInvertedSpriteOffset }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 10,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 16, 0, height - 5 + kInvertedSpriteOffset }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + kSupportHeight + 13,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 0, height - 5 + kInvertedSpriteOffset }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 13,
                        session.SupportColours);
                    break;
            }
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 16, height - 5 + kInvertedSpriteOffset + 8 }, { 16, 16, 3 } });
                ...
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 16, 16, height - 5 + kInvertedSpriteOffset + 8 }, { 16, 16, 3 } });
                ...
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 16, 0, height - 5 + kInvertedSpriteOffset + 8 }, { 16, 16, 3 } });
                ...
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 0, height - 5 + kInvertedSpriteOffset + 8 }, { 16, 16, 3 } });
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 16, 16, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 13,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 16, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + kSupportHeight + 18,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 0, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 18,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 16, 0, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 18,
                        session.SupportColours);
                    break;
            }
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 0, height - 5 + kInvertedSpriteOffset + 8 }, { 32, 16, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                ...
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 0, 16, height - 5 + kInvertedSpriteOffset + 8 }, { 32, 16, 3 } });
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
        ...
        case 4:
            ...
            {
                PaintUtilPushTunnelRotated(session, direction, height - 5 + 16, kTunnelGroup, TunnelSubType::SlopeEnd);
            }
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 80);
            break;
    }
            ...
            switch (direction)
            {
                ...
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { { 16, 16, height - 5 + kInvertedSpriteOffset }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 8,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { { 0, 0, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 17,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { { 16, 0, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 17,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                ...
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { { 0, 16, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + kSupportHeight + 15,
                        session.SupportColours);
                    break;
            }
        ...
        case 4:
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + kInvertedSpriteOffset },
                        { { 6, 0, height - 5 + kInvertedSpriteOffset + 8 }, { 20, 32, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::centre, 0, height - 5 + kSupportHeight + 10,
                        session.SupportColours);
                    break;
            ...
            {
                PaintUtilPushTunnelRotated(session, direction + 1, height - 5 + 8, kTunnelGroup, TunnelSubType::SlopeEnd);
            }
    ...
    const TrackElement& trackElement, SupportType supportType)
{
    switch (trackSequence)
    {
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { { 16, 16, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 17,
                        session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { { 0, 16, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + kSupportHeight + 17,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { { 0, 0, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + kSupportHeight + 19,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { { 16, 0, height - 5 + kInvertedSpriteOffset + 16 }, { 16, 16, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 15,
                        session.SupportColours);
                    break;
            }
        ...
        case 4:
            ...
            if (direction == 1 || direction == 2)
            {
                PaintUtilPushTunnelRotated(session, direction, height - 5 + 8, kTunnelGroup, TunnelSubType::SlopeEnd);
            }
        ...
        case 1:
            ...
            switch (direction)
            {
                ...
                case 1:
                    ...
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + kSupportHeight + 19,
                        session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                    ...
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + kSupportHeight + 19,
                        session.SupportColours);
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
    ...
    switch (trackSequence)
    {
            ...
            switch (direction)
            {
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 45 }, { 32, 32, 3 } });
                    break;
            }
            PaintUtilSetSegmentSupportHeight(
                session,
        ...
        case 2:
            ...
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + 52,
                        session.SupportColours);
                    break;
                case 1:

                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + 52, session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 45 }, { 32, 32, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + 52, session.SupportColours);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + 52, session.SupportColours);
                    break;
            }
    ...
    switch (trackSequence)
    {
        ...
        case 3:
            ...
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + 60, session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 45 }, { 32, 32, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + 60, session.SupportColours);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + 60, session.SupportColours);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + 60,
                        session.SupportColours);
                    break;
            }
    ...
    switch (trackSequence)
    {
        ...
        case 3:
            ...
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + 62, session.SupportColours);
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
    ...
    switch (trackSequence)
    {
            ...
            switch (direction)
            {
                case 3:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 37 }, { 32, 32, 3 } });
                    break;
            }
            PaintUtilSetSegmentSupportHeight(
                session,
        ...
        case 2:
            ...
            switch (direction)
            {
                case 0:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + 48,
                        session.SupportColours);
                    break;
                case 1:
                    MetalASupportsPaintSetup(
        ...
        case 2:
            ...
            switch (direction)
            {
                ...
                case 1:
                    ...
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + 54, session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
        ...
        case 2:
            ...
            switch (direction)
            {
                ...
                case 1:
                    ...
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::leftCorner, 0, height - 5 + 48, session.SupportColours);
                    break;
                case 2:
                    PaintAddImageAsParentRotated(
                ...
                case 3:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + 50, session.SupportColours);
                    break;
            }
            ...
            switch (direction)
            {
                ...
                case 1:
                    PaintAddImageAsParentRotated(
                        ...
                        { -16, -16, height - 5 + kInvertedSpriteOffset }, { { -16, -16, height - 5 + 37 }, { 32, 32, 3 } });
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::topCorner, 0, height - 5 + 48, session.SupportColours);
                    break;
                case 2:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::rightCorner, 0, height - 5 + 48, session.SupportColours);
                    break;
                case 3:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + 48,
    ...
    switch (trackSequence)
    {
        ...
        case 3:
            ...
            switch (direction)
            {
                ...
                case 3:
                    MetalASupportsPaintSetup(
                        session, supportType.metal, MetalSupportPlace::bottomCorner, 0, height - 5 + 50,
                        session.SupportColours);
                    break;
            }
    ...
    switch (trackSequence)
    {
        case 0:
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + 29 }, { { 0, 6, height - 5 + 35 }, { 32, 20, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
            ...
            PaintUtilSetSegmentSupportHeight(
                ...
                0xFFFF, 0);
            MetalASupportsPaintSetup(
                session, supportType.metal, MetalSupportPlace::centre, 0, height - 5 + 46, session.SupportColours);
            ...
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + 29 }, { { 0, 0, height - 5 + 43 }, { 32, 16, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
                ...
                case 2:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + 29 }, { { 0, 16, height - 5 + 43 }, { 32, 16, 3 } });
                    break;
                case 3:
                    PaintAddImageAsParentRotated(
        ...
        case 6:
            switch (direction)
            {
                case 0:
                    PaintAddImageAsParentRotated(
                        ...
                        { 0, 0, height - 5 + 29 }, { { 6, 0, height - 5 + 43 }, { 20, 32, 3 } });
                    break;
                case 1:
                    PaintAddImageAsParentRotated(
            ...
            PaintUtilSetSegmentSupportHeight(
                ...
                0xFFFF, 0);
            MetalASupportsPaintSetup(
                session, supportType.metal, MetalSupportPlace::centre, 0, height - 5 + 58, session.SupportColours);

            switch (direction)
            {
                case 2:
                    PaintUtilPushTunnelRight(session, height - 5 + 16, kTunnelGroup, TunnelSubType::Flat);
                    break;
                case 3:
                    PaintUtilPushTunnelLeft(session, height - 5 + 16, kTunnelGroup, TunnelSubType::Flat);
                    break;
            }
            PaintUtilSetGeneralSupportHeight(session, height - 5 + 48);
            break;
