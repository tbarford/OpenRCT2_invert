...
enum : ImageIndex
{
    ...
    //SPR_TRACKS_BM_INVERT_DIAG_BRAKES = SPR_TRACKS_SINGLE_RAIL_GENTLE_DIAG_BRAKE+4,
    //SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP = SPR_TRACKS_BM_INVERT_DIAG_BRAKES + 6,
    //SPR_TRACKS_BM_INVERT_VERTICAL = SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP + 20,
    //SPR_TRACKS_BM_INVERT_VERTICAL_TWIST = SPR_TRACKS_BM_INVERT_VERTICAL + 8,
    //SPR_TRACKS_BM_INVERT_QUARTER_LOOP = SPR_TRACKS_BM_INVERT_LARGE_CORKSCREW + 42,


    SPR_TRACKS_BM_INVERT_VERTICAL = SPR_TRACKS_SINGLE_RAIL_GENTLE_DIAG_BRAKE + 4,
    SPR_TRACKS_BM_INVERT_BARREL_ROLL = SPR_TRACKS_BM_INVERT_VERTICAL + 12,
    SPR_TRACKS_BM_INVERT_FLAT_TO_STEEP = SPR_TRACKS_BM_INVERT_BARREL_ROLL + 48,
    ...
    SPR_TRACKS_BM_INVERT_LARGE_CORKSCREW =  SPR_TRACKS_BM_INVERT_QUARTER_LOOP + 12,
    SPR_TRACKS_BM_INVERT_TURN_BANK_TRANSITION = SPR_TRACKS_BM_INVERT_LARGE_CORKSCREW + 40,
    SPR_TRACKS_BM_INVERT_MEDIUM_HALF_LOOP = SPR_TRACKS_BM_INVERT_TURN_BANK_TRANSITION + 18,
    ...
    SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP = SPR_TRACKS_BM_INVERT_DIVE_LOOP + 32,
    SPR_TRACKS_BM_INVERT_GENTLE_LARGE_CURVE = SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP + 20,
    SPR_TRACKS_BM_INVERT_GENTLE_LARGE_CURVE_BANKED = SPR_TRACKS_BM_INVERT_GENTLE_LARGE_CURVE + 64,


    SPR_TRACKS_END = SPR_TRACKS_BM_INVERT_GENTLE_LARGE_CURVE_BANKED + 128,
