...
enum : ImageIndex
{
    ...
    SPR_TRACKS_BM_INVERT_BARREL_ROLL = SPR_TRACKS_SINGLE_RAIL_GENTLE_DIAG_BRAKE + 4,
    SPR_TRACKS_BM_INVERT_LARGE_CORKSCREW = SPR_TRACKS_BM_INVERT_BARREL_ROLL + 48,
    SPR_TRACKS_BM_INVERT_MEDIUM_HALF_LOOP = SPR_TRACKS_BM_INVERT_LARGE_CORKSCREW + 40,
    ...
    SPR_TRACKS_BM_INVERT_TURN_BANK_TRANSITION = SPR_TRACKS_BM_INVERT_QUARTER_LOOP + 12,
    SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP = SPR_TRACKS_BM_INVERT_TURN_BANK_TRANSITION + 18,
