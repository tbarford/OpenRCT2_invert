...
enum : ImageIndex
{
    ...
    SPR_TRACKS_MINI_TRACK_DIAG_BRAKES = SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    SPR_TRACKS_MINI_TRACK_DIAG_BLOCK_BRAKES = SPR_TRACKS_MINI_TRACK_DIAG_BRAKES + 2,
    SPR_TRACKS_MINI_TRACK_VERTICAL = SPR_TRACKS_MINI_TRACK_DIAG_BLOCK_BRAKES + 4,
