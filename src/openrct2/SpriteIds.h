...
enum : ImageIndex
{
    ...
    SPR_TRACKS_INVERTED_IMPULSE_BEGIN = SPR_TRACKS_LIM_LAUNCHED_TRACK_END,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_SMALL_CURVE = SPR_TRACKS_INVERTED_IMPULSE_BEGIN + 0,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_MEDIUM_CURVE = SPR_TRACKS_INVERTED_IMPULSE_TRACK_SMALL_CURVE + 12,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_CURVE = SPR_TRACKS_INVERTED_IMPULSE_TRACK_MEDIUM_CURVE + 20,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_FLAT_DIAGONAL = SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_CURVE + 32,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_DIAGONAL = SPR_TRACKS_INVERTED_IMPULSE_TRACK_FLAT_DIAGONAL + 2,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_STEEP_DIAGONAL = SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_DIAGONAL + 12,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_BANK_TRANSITION = SPR_TRACKS_INVERTED_IMPULSE_TRACK_STEEP_DIAGONAL + 12,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_BANK_TRANSITION_DIAGONAL = SPR_TRACKS_INVERTED_IMPULSE_TRACK_BANK_TRANSITION + 40,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_SMALL_CURVE_BANKED = SPR_TRACKS_INVERTED_IMPULSE_TRACK_BANK_TRANSITION_DIAGONAL + 34,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_MEDIUM_CURVE_BANKED = SPR_TRACKS_INVERTED_IMPULSE_TRACK_SMALL_CURVE_BANKED + 14,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_CURVE_BANKED = SPR_TRACKS_INVERTED_IMPULSE_TRACK_MEDIUM_CURVE_BANKED + 22,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_SMALL_CURVE = SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_CURVE_BANKED + 32,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_MEDIUM_CURVE = SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_SMALL_CURVE + 16,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_STEEP_SMALL_CURVE = SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_MEDIUM_CURVE + 40,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_SLOPE_BANK_TRANSITION = SPR_TRACKS_INVERTED_IMPULSE_TRACK_STEEP_SMALL_CURVE + 16,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_TRACKS_INVERTED_IMPULSE_TRACK_SLOPE_BANK_TRANSITION + 64,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_MEDIUM_CURVE_BANKED = SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_SMALL_CURVE_BANKED
        + 16,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_S_BEND = SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_MEDIUM_CURVE_BANKED + 40,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_BARREL_ROLL = SPR_TRACKS_INVERTED_IMPULSE_TRACK_S_BEND + 16,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_HALF_LOOP = SPR_TRACKS_INVERTED_IMPULSE_TRACK_BARREL_ROLL + 48,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_FLAT_TO_STEEP = SPR_TRACKS_INVERTED_IMPULSE_TRACK_HALF_LOOP + 16,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_LOOP = SPR_TRACKS_INVERTED_IMPULSE_TRACK_FLAT_TO_STEEP + 32,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_CORKSCREW = SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_LOOP + 12,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_CORKSCREW = SPR_TRACKS_INVERTED_IMPULSE_TRACK_CORKSCREW + 24,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_TURN_BANK_TRANSITION = SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_CORKSCREW + 40,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_MEDIUM_HALF_LOOP = SPR_TRACKS_INVERTED_IMPULSE_TRACK_TURN_BANK_TRANSITION + 18,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_HALF_LOOP = SPR_TRACKS_INVERTED_IMPULSE_TRACK_MEDIUM_HALF_LOOP + 40,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_ZERO_G_ROLL = SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_HALF_LOOP + 56,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_ZERO_G_ROLL = SPR_TRACKS_INVERTED_IMPULSE_TRACK_ZERO_G_ROLL + 32,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_SMALL_FLAT_TO_STEEP = SPR_TRACKS_INVERTED_IMPULSE_TRACK_LARGE_ZERO_G_ROLL + 40,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_DIAG_SLOPED_BANKING = SPR_TRACKS_INVERTED_IMPULSE_TRACK_SMALL_FLAT_TO_STEEP + 20,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_LARGE_CURVE_BANKED = SPR_TRACKS_INVERTED_IMPULSE_TRACK_DIAG_SLOPED_BANKING + 56,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_LARGE_CURVE = SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_LARGE_CURVE_BANKED + 64,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_TRACKS_INVERTED_IMPULSE_TRACK_GENTLE_LARGE_CURVE + 64,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_DIVE_LOOP = SPR_TRACKS_INVERTED_IMPULSE_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_HELIX_LEFT = SPR_TRACKS_INVERTED_IMPULSE_TRACK_DIVE_LOOP + 32,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_HELIX_RIGHT = SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_HELIX_LEFT_BANKED = SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_HELIX_RIGHT + 20,
    SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_HELIX_RIGHT_BANKED = SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_HELIX_LEFT_BANKED
        + 20,
    SPR_TRACKS_INVERTED_IMPULSE_END = SPR_TRACKS_INVERTED_IMPULSE_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,

    SPR_TRACKS_FLUME_25_60_NE_SW = SPR_TRACKS_INVERTED_IMPULSE_END,
