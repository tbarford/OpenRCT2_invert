...
enum : ImageIndex
{
    ...
    SPR_JUMPING_FOUNTAIN_WATER = 22973,
    SPR_JUMPING_FOUNTAIN_SNOW = 23037,
    ...
    SPR_TRACKS_BEGIN = 29357,
    SPR_TRACKS_EMPTY = SPR_TRACKS_BEGIN,
    SPR_TRACKS_PLACEHOLDER,
    ...
    SPR_TRACKS_LOGO,
    SPR_TRACKS_TITLE,
    SPR_TRACKS_FASTFORWARD,
    SPR_TRACKS_SPEED_ARROW,
    SPR_TRACKS_HYPER_ARROW,
    SPR_TRACKS_TAB_LAND,
    SPR_TRACKS_ZOOM_IN,
    SPR_TRACKS_ZOOM_IN_DISABLED,
    SPR_TRACKS_ZOOM_OUT,
    SPR_TRACKS_ZOOM_OUT_DISABLED,
    SPR_TRACKS_TAB_TREE,
    SPR_TRACKS_TAB_PENCIL,
    SPR_TRACKS_BUTTON_LARGE_SCENERY,
    SPR_TRACKS_BUTTON_TREES,
    SPR_TRACKS_BUTTON_FOOTPATH,
    SPR_TRACKS_RCT1_CLOSE_BUTTON_0,
    SPR_TRACKS_RCT1_CLOSE_BUTTON_1,
    SPR_TRACKS_RCT1_CLOSE_BUTTON_2,
    SPR_TRACKS_RCT1_CLOSE_BUTTON_3,
    SPR_TRACKS_RCT1_TEST_BUTTON_0,
    SPR_TRACKS_RCT1_TEST_BUTTON_1,
    SPR_TRACKS_RCT1_TEST_BUTTON_2,
    SPR_TRACKS_RCT1_TEST_BUTTON_3,
    SPR_TRACKS_RCT1_OPEN_BUTTON_0,
    SPR_TRACKS_RCT1_OPEN_BUTTON_1,
    SPR_TRACKS_RCT1_OPEN_BUTTON_2,
    SPR_TRACKS_RCT1_OPEN_BUTTON_3,
    SPR_TRACKS_TITLE_RESTART,
    SPR_TRACKS_TITLE_STOP,
    SPR_TRACKS_TITLE_PLAY,
    SPR_TRACKS_TITLE_SKIP,
    SPR_TRACKS_SANDBOX,
    SPR_TRACKS_TAB_NEWS,
    SPR_TRACKS_LOCKED,
    SPR_TRACKS_MENU_MULTIPLAYER,
    SPR_TRACKS_SORT,
    SPR_TRACKS_COPY,
    SPR_TRACKS_PASTE,
    SPR_TRACKS_TOOLBAR_MUTE,
    SPR_TRACKS_TOOLBAR_MUTE_PRESSED,
    SPR_TRACKS_TOOLBAR_UNMUTE,
    SPR_TRACKS_TOOLBAR_UNMUTE_PRESSED,
    SPR_TRACKS_SEARCH,
    SPR_TRACKS_EYEDROPPER,
    SPR_TRACKS_CHAT,
    SPR_TRACKS_MAP_NORTH,
    SPR_TRACKS_MAP_NORTH_PRESSED,
    SPR_TRACKS_MAP_WEST,
    SPR_TRACKS_MAP_WEST_PRESSED,
    SPR_TRACKS_MAP_SOUTH,
    SPR_TRACKS_MAP_SOUTH_PRESSED,
    SPR_TRACKS_MAP_EAST,
    SPR_TRACKS_MAP_EAST_PRESSED,
    SPR_TRACKS_TOOLBAR_MULTIPLAYER,
    SPR_TRACKS_TOOLBAR_MULTIPLAYER_PRESSED,
    SPR_TRACKS_MULTIPLAYER_SYNC,
    SPR_TRACKS_MULTIPLAYER_DESYNC,
    SPR_TRACKS_SIMULATE,
    SPR_TRACKS_RCT1_SIMULATE_BUTTON_0,
    SPR_TRACKS_RCT1_SIMULATE_BUTTON_1,
    SPR_TRACKS_RCT1_SIMULATE_BUTTON_2,
    SPR_TRACKS_RCT1_SIMULATE_BUTTON_3,
    SPR_TRACKS_INFINITY,
    SPR_TRACKS_LAND_TOOL_SIZE_6,
    SPR_TRACKS_MOUNTAIN_TOOL_EVEN,
    SPR_TRACKS_MOUNTAIN_TOOL_ODD,
    SPR_TRACKS_SCENERY_SCATTER_LOW,
    SPR_TRACKS_SCENERY_SCATTER_MEDIUM,
    SPR_TRACKS_SCENERY_SCATTER_HIGH,
    SPR_TRACKS_VIEW,
    SPR_TRACKS_PATH_RAILINGS_TAB,
    SPR_TRACKS_LEGACY_PATH_TAB,
    SPR_TRACKS_PATH_SURFACE_TAB,
    SPR_TRACKS_RIDE_STATION_TAB,
    SPR_TRACKS_TERRAIN_EDGE_TAB,
    SPR_TRACKS_BUTTON_HIDE_VEGETATION,
    SPR_TRACKS_BUTTON_HIDE_SCENERY,
    SPR_TRACKS_BUTTON_HIDE_VEHICLES,
    SPR_TRACKS_BUTTON_HIDE_SUPPORTS,
    SPR_TRACKS_BUTTON_HIDE_PARTIAL,
    SPR_TRACKS_BUTTON_HIDE_FULL,
    SPR_TRACKS_LINK_CHAIN,
    SPR_TRACKS_SIDEWAYS_TAB,
    SPR_TRACKS_SIDEWAYS_TAB_ACTIVE,
    SPR_TRACKS_ARROW_UP,
    SPR_TRACKS_ARROW_DOWN,
    SPR_TRACKS_RELOAD,
    SPR_TRACKS_MAP_GEN_TERRAIN_TAB,
    SPR_TRACKS_MAP_GEN_BTN,
    SPR_TRACKS_PEEP_SPAWN,
    SPR_TRACKS_ICON_PALETTE_INVISIBLE,
    SPR_TRACKS_ICON_PALETTE_INVISIBLE_PRESSED,
    SPR_TRACKS_ICON_PALETTE_LARGE,
    SPR_TRACKS_ICON_PALETTE_PRESSED_LARGE,
    SPR_TRACKS_ICON_PALETTE_INVISIBLE_LARGE,
    SPR_TRACKS_ICON_PALETTE_INVISIBLE_PRESSED_LARGE,
    SPR_TRACKS_FOLDER,
    SPR_TRACKS_FOLDER_NEW,
    SPR_TRACKS_FOLDER_PARENT,
    SPR_TRACKS_FOLDER_DEFAULT,
    SPR_TRACKS_SYSTEM_BROWSER,
    SPR_TRACKS_PEEP_ANIMATIONS,
    SPR_TRACKS_WEATHER_SUN_SMALL,
    SPR_TRACKS_WEATHER_SUN_CLOUD_SMALL,
    SPR_TRACKS_WEATHER_CLOUD_SMALL,
    SPR_TRACKS_WEATHER_LIGHT_RAIN_SMALL,
    SPR_TRACKS_WEATHER_HEAVY_RAIN_SMALL,
    SPR_TRACKS_WEATHER_STORM_SMALL,
    SPR_TRACKS_WEATHER_SNOW,
    SPR_TRACKS_WEATHER_SNOW_SMALL,
    SPR_TRACKS_WEATHER_HEAVY_SNOW,
    SPR_TRACKS_WEATHER_HEAVY_SNOW_SMALL,
    SPR_TRACKS_WEATHER_BLIZZARD,
    SPR_TRACKS_WEATHER_BLIZZARD_SMALL,
    SPR_TRACKS_MONITOR_TAB_START,
    SPR_TRACKS_MONITOR_TAB_END = SPR_TRACKS_MONITOR_TAB_START + 15,
    SPR_TRACKS_CONTROLS_TAB_START,
    SPR_TRACKS_CONTROLS_TAB_END = SPR_TRACKS_CONTROLS_TAB_START + 7,
    SPR_TRACKS_LOGO_MONO_DITHERED,

    // G2 Loading progress

    SPR_TRACKS_LOADER_START = SPR_TRACKS_LOGO_MONO_DITHERED + 1,
    SPR_TRACKS_LOADER_HYBRID_SUPPORTS = SPR_TRACKS_LOADER_START,
    SPR_TRACKS_LOADER_HYBRID_TRACK,
    SPR_TRACKS_LOADER_HYBRID_VEHICLE,
    SPR_TRACKS_LOADER_STEEL_SUPPORTS,
    SPR_TRACKS_LOADER_STEEL_TRACK,
    SPR_TRACKS_LOADER_STEEL_VEHICLE,
    SPR_TRACKS_LOADER_WOODEN_SUPPORTS,
    SPR_TRACKS_LOADER_WOODEN_TRACK,
    SPR_TRACKS_LOADER_WOODEN_VEHICLE,
    SPR_TRACKS_LOADER_GO_KARTS_SUPPORTS,
    SPR_TRACKS_LOADER_GO_KARTS_TRACK,
    SPR_TRACKS_LOADER_GO_KARTS_VEHICLES,

    // G2 Misc

    SPR_TRACKS_SURFACE_GLASSY_RECOLOURABLE,
    SPR_TRACKS_SELECTION_EDGE_NW,
    SPR_TRACKS_SELECTION_EDGE_NE,
    SPR_TRACKS_SELECTION_EDGE_SW,
    SPR_TRACKS_SELECTION_EDGE_SE,

    SPR_TRACKS_OPAQUE_WATER_OVERLAY,

    SPR_TRACKS_ICON_MEDIUM_CURVE_LEFT = SPR_TRACKS_OPAQUE_WATER_OVERLAY + 5,
    SPR_TRACKS_ICON_MEDIUM_CURVE_RIGHT,
    SPR_TRACKS_ICON_ROTATE_ANTI_CLOCKWISE,
    SPR_TRACKS_ICON_PATH_DRAG_TOOL,
    SPR_TRACKS_ICON_VISIBILITY_TOGGLE,
    SPR_TRACKS_BUTTON_PATH_ADDITIONS,
    SPR_TRACKS_BUTTON_WALLS,

    SPR_TRACKS_END,

    // Main palettes
    SPR_PALETTE_START = SPR_TRACKS_END,
    ...
    SPR_FONTS_CYRILLIC_HARD_SIGN_LOWER,
    ...
    SPR_TRACKS_MINI_TRACK_DIAG_BLOCK_BRAKES = SPR_TRACKS_MINI_TRACK_DIAG_BRAKES + 2,
    SPR_TRACKS_MINI_TRACK_VERTICAL = SPR_TRACKS_MINI_TRACK_QUARTER_HELIX_RIGHT_BANKED + 20,
    SPR_TRACKS_MINI_TRACK_VERTICAL_TWIST = SPR_TRACKS_MINI_TRACK_VERTICAL + 12,
    SPR_TRACKS_MINI_TRACK_BARREL_ROLL = SPR_TRACKS_MINI_TRACK_VERTICAL_TWIST + 12,
    SPR_TRACKS_MINI_TRACK_HALF_LOOP = SPR_TRACKS_MINI_TRACK_BARREL_ROLL + 48,
    SPR_TRACKS_MINI_TRACK_VERTICAL_LOOP = SPR_TRACKS_MINI_TRACK_HALF_LOOP + 16,
    SPR_TRACKS_MINI_TRACK_FLAT_TO_STEEP = SPR_TRACKS_MINI_TRACK_VERTICAL_LOOP + 32,
    SPR_TRACKS_MINI_TRACK_QUARTER_LOOP = SPR_TRACKS_MINI_TRACK_FLAT_TO_STEEP + 32,
    SPR_TRACKS_MINI_TRACK_CORKSCREW = SPR_TRACKS_MINI_TRACK_QUARTER_LOOP + 12,
    SPR_TRACKS_MINI_TRACK_LARGE_CORKSCREW = SPR_TRACKS_MINI_TRACK_CORKSCREW + 24,
    SPR_TRACKS_MINI_TRACK_TURN_BANK_TRANSITION = SPR_TRACKS_MINI_TRACK_LARGE_CORKSCREW + 40,
    SPR_TRACKS_MINI_TRACK_MEDIUM_HALF_LOOP = SPR_TRACKS_MINI_TRACK_TURN_BANK_TRANSITION + 18,
    SPR_TRACKS_MINI_TRACK_LARGE_HALF_LOOP = SPR_TRACKS_MINI_TRACK_MEDIUM_HALF_LOOP + 40,
    SPR_TRACKS_MINI_TRACK_ZERO_G_ROLL = SPR_TRACKS_MINI_TRACK_LARGE_HALF_LOOP + 56,
    SPR_TRACKS_MINI_TRACK_LARGE_ZERO_G_ROLL = SPR_TRACKS_MINI_TRACK_ZERO_G_ROLL + 32,
    SPR_TRACKS_MINI_TRACK_SMALL_FLAT_TO_STEEP = SPR_TRACKS_MINI_TRACK_LARGE_ZERO_G_ROLL + 40,
    SPR_TRACKS_MINI_TRACK_GENTLE_LARGE_CURVE = SPR_TRACKS_MINI_TRACK_SMALL_FLAT_TO_STEEP + 20,
    SPR_TRACKS_MINI_TRACK_GENTLE_LARGE_CURVE_BANKED = SPR_TRACKS_MINI_TRACK_GENTLE_LARGE_CURVE + 64,
    SPR_TRACKS_MINI_TRACK_INLINE_TWIST = SPR_TRACKS_MINI_TRACK_GENTLE_LARGE_CURVE_BANKED + 128,
    SPR_TRACKS_MINI_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_TRACKS_MINI_TRACK_INLINE_TWIST + 48,
    SPR_TRACKS_MINI_TRACK_DIVE_LOOP = SPR_TRACKS_MINI_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_TRACKS_MINI_RC_END = SPR_TRACKS_MINI_TRACK_DIVE_LOOP + 32,
    ...
    SPR_TRACKS_BM_INVERT_BARREL_ROLL = SPR_TRACKS_BM_INVERT_DIAG_BRAKES + 2,
    SPR_TRACKS_BM_INVERT_LARGE_CORKSCREW = SPR_TRACKS_BM_INVERT_BARREL_ROLL + 48,
    SPR_TRACKS_BM_INVERT_MEDIUM_HALF_LOOP = SPR_TRACKS_BM_INVERT_LARGE_CORKSCREW + 46,
    SPR_TRACKS_BM_INVERT_ZERO_G_ROLL = SPR_TRACKS_BM_INVERT_MEDIUM_HALF_LOOP + 40,
    SPR_TRACKS_BM_INVERT_LARGE_ZERO_G_ROLL = SPR_TRACKS_BM_INVERT_ZERO_G_ROLL + 32,
    SPR_TRACKS_BM_INVERT_DIVE_LOOP = SPR_TRACKS_BM_INVERT_LARGE_ZERO_G_ROLL + 40,
    SPR_TRACKS_BM_INVERT_VERTICAL = SPR_TRACKS_BM_INVERT_DIVE_LOOP + 32,
    SPR_TRACKS_BM_INVERT_FLAT_TO_STEEP = SPR_TRACKS_BM_INVERT_VERTICAL + 26,
    SPR_TRACKS_BM_INVERT_FLAT_TO_STEEP_DIAGONAL = SPR_TRACKS_BM_INVERT_FLAT_TO_STEEP + 32,
    SPR_TRACKS_BM_INVERT_QUARTER_LOOP = SPR_TRACKS_BM_INVERT_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_TRACKS_BM_INVERT_TURN_BANK_TRANSITION = SPR_TRACKS_BM_INVERT_QUARTER_LOOP + 14,
    SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP = SPR_TRACKS_BM_INVERT_TURN_BANK_TRANSITION + 16,
    SPR_TRACKS_BM_INVERT_GENTLE_LARGE_CURVE = SPR_TRACKS_BM_INVERT_SMALL_FLAT_TO_STEEP + 20,
    SPR_TRACKS_BM_INVERT_DIAG_SLOPED_BANKING = SPR_TRACKS_BM_INVERT_GENTLE_LARGE_CURVE + 64,
    SPR_TRACKS_BM_INVERT_GENTLE_LARGE_CURVE_BANKED = SPR_TRACKS_BM_INVERT_DIAG_SLOPED_BANKING + 56,
    SPR_TRACKS_BM_INVERT_QUARTER_HELIX_LEFT = SPR_TRACKS_BM_INVERT_GENTLE_LARGE_CURVE_BANKED + 64,
    SPR_TRACKS_BM_INVERT_QUARTER_HELIX_RIGHT = SPR_TRACKS_BM_INVERT_QUARTER_HELIX_LEFT + 20,
    SPR_TRACKS_BM_INVERT_RC_END = SPR_TRACKS_BM_INVERT_QUARTER_HELIX_RIGHT + 20,
...
constexpr size_t kG2SpriteCount = SPR_TRACKS_END - SPR_TRACKS_BEGIN;
